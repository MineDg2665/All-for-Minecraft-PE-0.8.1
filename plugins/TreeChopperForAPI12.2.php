...
class TreeChopper implements Plugin {
    ...
    public function init() {
        ...
        $this->api->console->register("tc", "On/Off TreeChopper.", array($this, "commandHandler"));
    ...
    private function cancelAction(Block $target, Player $player) {
        $player->addBlockUpdateIntoQueue($target->x, $target->y, $target->z, $target->getID(), $target->getMetadata());
        return false;
    }
